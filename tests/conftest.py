...
# Monkeypatch для установки reactor на Windows
try:
    from scrapy.utils import ossignal
    _original_install_shutdown_handlers = ossignal.install_shutdown_handlers
    def _patched_install_shutdown_handlers(function, override_sigint=True):
        # Просто игнорируем установку обработчиков сигналов на Windows
        pass
    ossignal.install_shutdown_handlers = _patched_install_shutdown_handlers
except Exception:
    pass
